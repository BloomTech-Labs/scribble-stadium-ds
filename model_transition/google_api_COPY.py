"""
This was copied from app/utils/img-processing/google_api.py
...
Main purpose of this file:
 	The “GoogleAPI” class does a lot:
        ...
        3 Calculates overall confidence score (by symbol not word) and 
          returns True (confidence < 0.85) or False (≥0.85)
...
Assessment:
    ...
    2 #4 uses an in-house function and word list that should work with 
      Tesseract output (app/utils/moderation/text_moderation.py).

To Do:
    Mark/highlight code that needs to be changed to handle Tesseract

In the code below, areas that use Google Vision are bracketed with lines of 
########################################################################
"""
