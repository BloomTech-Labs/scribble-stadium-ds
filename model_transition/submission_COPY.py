"""
This was copied from app/api/submission.py
...
Assessment:
        Will need some modifications to handle Tesseract, but nothing major as long 
        as the same data items can be obtained from Tesseract in the same format.
        These items are: [confidence flag, content flag, transcript]
